...
const Port = 'https://pannapulsefood.onrender.com'|| 'http://localhost:3000'
...
// change profile save button

let confirm_profile = document.querySelector("#cnfrProfile");
confirm_profile.addEventListener("click", ()=>{
